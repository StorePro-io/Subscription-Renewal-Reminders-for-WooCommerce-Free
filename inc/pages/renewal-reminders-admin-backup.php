...
class SPRRAdmin
{
	...
	public function sprr_register() 
	{
		...
		$this->sprr_setFields();
		$this->sprr_setMarketingSections();
		$this->sprr_setMarketingFields();
	...
	public function sprr_setSettings()
	{
		$args = array(
			...
			// Marketing settings
			array(
				'option_group' => 'sprr_marketing_options_group',
				'option_name' => 'sprr_winback_email_subject',
				'sanitize_callback' => 'sanitize_text_field'
			),
			array(
				'option_group' => 'sprr_marketing_options_group',
				'option_name' => 'sprr_winback_email_content',
